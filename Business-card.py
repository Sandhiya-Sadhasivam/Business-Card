...
st.set_page_config(page_title= "BusinessCard: Extracting Business Card Data with OCR ",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Sandhiya*!"""})
st.markdown("<h1 style='text-align: center; color: white; font-style: oblique'>Get Card Info here</h1>", unsafe_allow_html=True)
